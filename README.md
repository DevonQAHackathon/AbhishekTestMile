...
dir.ui.ghost.tests is the package contains tests.

GhostTestClass.java is the Test class.


dir.ui.ghost.tests.pages contains the individual page classes.


dir.ui.ghost.tests.enums contains the individual Element mapper file of each page.


UI Element locator were externalized to file in the ../PC_WEB_AUTO\autocognite-arjuna-0.3.6-b\autocognite-arjuna\uiauto_maps\ghost


Externalized test data could be found the the below location. PC_WEB_AUTO\autocognite-arjuna-0.3.6-b\autocognite-arjuna\data\sources
